...
// Search global do header foi removida — baixa taxa de uso (sellers preferem
// navegar via sidebar) + roubava real estate horizontal. A funcionalidade de
// busca continua existindo na /transactions via filtro `?q=` próprio dessa
// página, que tem UX mais rica (filtros combinados, status, período).
    ...
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            className="items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-99999 dark:border-gray-800 lg:flex dark:text-gray-400 lg:border"
          ...
          <Link href="/" className="lg:hidden">
            <Image
              width={120}
              height={32}
              src="/images/fellow/fellow-pay-full-logo.PNG"
              alt="Fellow Pay"
            />
          </Link>
